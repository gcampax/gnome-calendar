...
gcal_manager_constructed (GObject *object)
{
  ...
  g_object_connect (sources,
		    "signal::source-added", on_source_added, object,
		    "signal::source-removed", on_source_removed, object,
		    NULL);
}
                         ...
                         const gchar *color)
{
  ...
  error = NULL;
  e_source_registry_commit_source_sync (priv->source_registry, source,
					NULL, &error);
  if (error)
    {
